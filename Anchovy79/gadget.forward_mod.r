...
#    }
	...
	rec.forward.steps <-matrix(c(tail(rec$recruitment,8)[c(3:6)],rep(0,steps)),nr=num.trials, nc=steps + 4, dimnames = list(trial = 1:num.tr		ials,step = 1:(steps+4)), byrow=T) #Take 3,4 of the previous year and 1 2 of the year as initial recruitments
#    if (num.trials == 1) {
