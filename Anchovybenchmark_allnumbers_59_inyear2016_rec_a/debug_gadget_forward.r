...
gadget.forward(years = 1,params.file = "WGTS/params.final",
               ...
               gd=list(dir='.',rel.dir='PRE_final_opt_3'),
               #method = 'custom',
...
stochastic = FALSE;
rec.window = c(2011:2016);
gd=list(dir='.',rel.dir='PRE_final_opt_2');
method = 'custom';
ref.years=c(1989:2015);
custom.print=NULL;
#prj.func = Proj.rec;
...
#fit<-out
#load("/run/user/1000/gvfs/sftp:host=ft2.cesga.es,user=csmdpmrh/mnt/netapp1/Store_CSIC/home/csic/mdp/mrh/GADGET_backup/Anchovy2018_benchmark_allnumbers_59_inyear2016_rec_a/PRE_final_opt_3/out.Rdata")
